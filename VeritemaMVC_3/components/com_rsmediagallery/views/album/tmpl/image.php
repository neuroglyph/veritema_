...
?>
	...
	<div id="rsmg_main">
		<p>
		<?php if ($this->adjacent->prev) { ?><a href="<?php echo RSMediaGalleryRoute::_('index.php?option=com_rsmediagallery&view=album&layout=image&tag='.urlencode($this->tag).'&id='.$this->adjacent->prev->filepart.'&ext='.$this->adjacent->prev->fileext); ?>" class="rsmg_float_left"><?php echo JText::_('COM_RSMEDIAGALLERY_PREVIOUS'); ?></a><?php } ?>
		<?php if ($this->adjacent->next) { ?><a href="<?php echo RSMediaGalleryRoute::_('index.php?option=com_rsmediagallery&view=album&layout=image&tag='.urlencode($this->tag).'&id='.$this->adjacent->next->filepart.'&ext='.$this->adjacent->next->fileext); ?>" class="rsmg_float_right"><?php echo JText::_('COM_RSMEDIAGALLERY_NEXT'); ?></a><?php } ?>
		</p>
    	...
    	<div id="rsmg_image_container" class="rsmg_hidden_from_view">
			...
			<div class="rsmg_back"><a href="<?php echo RSMediaGalleryRoute::_('index.php?option=com_rsmediagallery&view=album&tag='.urlencode($this->tag)); ?>"><?php echo JText::_('COM_RSMEDIAGALLERY_BACK_TO_ALBUM'); ?></a></div>
