...
function TransMenuItem(sText, sUrl, oParent, sTarget,active,id,iDirection) {
        ...
        function toString(bDingbat) {
                ...
                menustring+='<td style="border:none;' + sPaddingRight + '" border="0">' +

                       '<img src="' + sDingbat + '" ></td>';

                  }

                menustring+= '<td nowrap style="border:none;' + sPaddingLeft + '" id="' + id + '" border="0">' +
                ...
                menustring+='<td style="border:none;' + sPaddingRight + '">' +

                        '<img src="' + sDingbat + '" border="0"></td>';
